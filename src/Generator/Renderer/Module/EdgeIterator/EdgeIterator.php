...
/**
 * Contour tracer for module groups, inspired by Potrace.
 *
 * The iterator walks a `ByteMatrix`, finds the outlines of filled regions, and
 * yields them as `Edge` objects. Each yielded edge is XORed back out of the
 * working bitmap so subsequent scans can locate the next contour.
...
final class EdgeIterator implements IteratorAggregate
{
    ...
    /**
     * Yield every traced contour in the matrix.
     *
    ...
    /**
     * Find the next still-filled point at or after the supplied coordinate.
     *
    ...
    /**
     * Trace one contour starting from the supplied point.
     */
    ...
    /**
     * XOR the traced contour back out of the working bitmap.
     */
    ...
    /**
     * Return whether the working bitmap contains a filled module at the given
     * coordinate.
     */
    ...
    /**
     * Convert a flattened byte index into an `[x, y]` point.
     *
     * @return array<int>
     */
    ...
    /**
     * Toggle one working-bitmap cell.
     */
