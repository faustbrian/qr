...
test('get next set1', function (): void {
...
test('get next set2', function (): void {
    $array = new BitArray(33);
...
test('get next set3', function (): void {
...
test('get next set4', function (): void {
    $array = new BitArray(63);
    $array->set(33);
    $array->set(40);
...
test('get next set5', function (): void {
...
test('append bit grows the logical size', function (): void {
    $array = new BitArray();
