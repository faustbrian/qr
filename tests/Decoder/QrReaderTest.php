 ...
 * @internal
 */
final class QrReaderTest extends TestCase
{
    ...
    public function test_text1(): void
    {
    ...
    public function test_no_text(): void
    {
    ...
    public function test_text2(): void
    {
    ...
    public function test_text3(): void
    {
    ...
    // {
    // 	$image = dirname(__DIR__) . "/Decoder/fixtures/qrcodes/174419877-f6b5dae1-2251-4b67-95f1-5e1143e40fae.jpg";
    // 	$qrcode = new QrReader($image);
    // 	$qrcode->decode([
    // 		'TRY_HARDER' => true,
    // 		'NR_ALLOW_SKIP_ROWS' => 0,
